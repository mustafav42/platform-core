...
$productsByCategory=[];foreach($products as $product){$productsByCategory[(int)$product['category_id']][]=$product;}
require __DIR__.'/_header.php';
?>
<meta name="ch-csrf" content="<?=ent_e($_SESSION['csrf_token'])?>">
<link rel="stylesheet" href="assets/sortable-manager.css?v=29.1.0">
<script>document.documentElement.dataset.reorderEndpoint='reorder.php';</script>
