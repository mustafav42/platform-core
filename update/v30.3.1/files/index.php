...
?><section class="category-directory" aria-labelledby="category-directory-title">
  <?php if($showDirectoryIntro):?><header class="directory-head">
    <span><?=e($directoryEyebrow)?></span>
    <h2 id="category-directory-title"><?=e($directoryTitle)?></h2>
    <p><?=e($directoryDescription)?></p>
  </header><?php endif;?>
