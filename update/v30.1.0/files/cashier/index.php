...
$staffId=(int)$_SESSION['cashier_id'];$selected=(int)($_GET['session']??0);$categoryId=(int)($_GET['category']??0);
...
try{
 if($_SERVER['REQUEST_METHOD']==='POST'&&isset($_POST['action'])){verify_csrf();$action=(string)$_POST['action'];
  ...
  if(in_array($action,['qty_plus','qty_minus','cancel_item','complimentary','save_note'],true)){$sid=(int)$_POST['session_id'];$iid=(int)$_POST['item_id'];
   ...
   if($action==='cancel_item')$pdo->prepare("UPDATE order_items oi JOIN orders o ON o.id=oi.order_id SET oi.status='cancelled' WHERE oi.id=? AND o.session_id=?")->execute([$iid,$sid]);
...
?><!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no"><title>CherryHouse POS · Kasiyer</title><link rel="stylesheet" href="../app/assets/pos-v4.css?v=420"><link rel="stylesheet" href="../app/assets/cherry-design/tokens.css?v=300"><link rel="stylesheet" href="../app/assets/pos-v5-alpha.css?v=3010"><link rel="stylesheet" href="../app/assets/cashier-v55.css?v=545"><link rel="stylesheet" href="../app/assets/table-flow-hotfix.css?v=2701"><script defer src="../app/assets/pos-v4.js?v=420"></script><script defer src="../app/assets/pos-v5-alpha.js?v=3010"></script><script defer src="../app/assets/cashier-v55.js?v=545"></script></head><body class="chv4 chv4-cashier ch-pos5">
<header class="v4-topbar"><a class="v4-back" href="../admin/">‹</a><div class="v4-brand"><span class="v4-mark">🍒</span><div><strong><?=e(setting('business_name','CherryHouse'))?></strong><small>POS 5.0 Alpha · Kasiyer</small></div></div><div class="v4-top-status"><span class="online-dot"></span> İnternet <b>Bağlı</b><span class="server-dot"></span> Sunucu <b>Aktif</b><b class="v4-live-clock" data-live-clock></b></div><button type="button" class="v4-fullscreen" data-fullscreen title="Tam ekran">⛶</button><div class="v4-user"><span><?=e($_SESSION['cashier_name']??'Kasiyer')?></span><a href="?logout=1">Çıkış</a></div></header>
<?php if($error):?><div class="v4-alert danger"><?=e($error)?></div><?php endif;?>
