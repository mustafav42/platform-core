...
final class ControlCenterRegistry
{
    ...
    public static function navigation(): array
    {
        return [
            ...
            self::group('management', 'Yönetim', [
                self::item('staff', 'Personel', 'compatibility.php?tool=staff', '♙', 'staff.manage', null, false, ['personel','kullanıcı','garson']),
                self::item('permissions', 'Roller ve Yetkiler', 'compatibility.php?tool=permissions', '◈', 'permissions.manage', null, false, ['rol','yetki']),
                ...
                self::item('ui-audit', 'UI Denetimi ve Rapor', 'ui-audit.php', '◉', 'modules.manage', null, false, ['ui audit','arayüz','tutarlılık','bileşen','dışa aktar','rapor']),
            ]),
        ];
    }
    ...
    public static function quickActions(): array
    {
        $actions=[
            ...
            self::item('quick-staff','Personel Ekle','compatibility.php?tool=staff&action=create','＋','staff.manage',null,false,['personel ekle']),
