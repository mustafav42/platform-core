...
$menuItems = [
    ...
    ['id'=>'menu','href'=>'menu.php','icon'=>'▤','label'=>'Menü Merkezi','keywords'=>'menü ürün kategori fiyat qr pos'],
    ['id'=>'products','href'=>'products.php','icon'=>'□','label'=>'Ürünler','keywords'=>'ürün fiyat yemek görsel alerjen kalori'],
    ...
    ['id'=>'media','href'=>'media.php','icon'=>'▧','label'=>'Medya Merkezi','keywords'=>'görsel resim yükleme dosya image studio kırpma'],
    ['id'=>'qrx','href'=>'../qr-experience/','icon'=>'◈','label'=>'QR Experience Studio','keywords'=>'tema hero tasarım menü canlı önizleme'],
    ['id'=>'qr-inspector','href'=>'qr-inspector.php','icon'=>'✓','label'=>'QR Kalite Kontrolü','keywords'=>'qr kontrol kalite eksik görsel açıklama yayına hazır'],
    ['id'=>'pos','href'=>'../../cashier/','icon'=>'▣','label'=>'POS / Kasa','keywords'=>'kasa ödeme masa adisyon'],
    ['id'=>'staff','href'=>'../../staff/','icon'=>'◉','label'=>'Garson Paneli','keywords'=>'garson sipariş masa'],
    ['id'=>'kds','href'=>'../../kitchen/','icon'=>'◫','label'=>'KDS / Mutfak','keywords'=>'mutfak sipariş hazırlık'],
    ['id'=>'audit','href'=>'audit.php','icon'=>'◎','label'=>'İşlem Geçmişi','keywords'=>'audit log geçmiş güvenlik değişiklik'],
    ['id'=>'settings','href'=>'../?page=maintenance','icon'=>'⚙','label'=>'Sistem Merkezi','keywords'=>'sistem sağlık yedekleme ayar'],
];
?><!doctype html>
<html lang="tr">
<head>
...
<link rel="stylesheet" href="../assets/ch-media-library.css?v=3033"></head>
...
<aside class="enterprise-sidebar" data-admin-sidebar>
    <div class="sidebar-head">
        <a class="enterprise-brand" href="./"><span>CH</span><div><strong><?=ent_e($businessName)?></strong><small>Aurora v30.3</small></div></a>
    ...
    <nav class="enterprise-nav" aria-label="Yönetim menüsü">
        ...
        <?php endforeach;?>
        <a href="../?page=dashboard"><span>↙</span><b>Klasik Yönetim</b></a>
    </nav>
...
<header class="enterprise-topbar">
    ...
    <div class="topbar-actions">
        ...
        <details class="notification-menu" data-notification-menu><summary class="icon-button" aria-label="Bildirimler">♢<?php if($unreadNotificationCount>0):?><i></i><em><?=number_format($unreadNotificationCount)?></em><?php endif;?></summary><div class="notification-panel"><header><strong>Bildirim Merkezi</strong><span><?=$unreadNotificationCount?> okunmamış</span></header><div data-notification-list><?php if($enterpriseNotifications): foreach($enterpriseNotifications as $notification):?><a href="<?=ent_e($notification['target_url'] ?: './')?>" class="notification-item <?=((int)$notification['is_read']===0)?'unread':''?>" data-notification-id="<?=(int)$notification['id']?>"><b><?=ent_e($notification['title'])?></b><span><?=ent_e($notification['message'])?></span><small><?=ent_e(date('d.m H:i',strtotime((string)$notification['created_at'])))?></small></a><?php endforeach; else:?><p class="notification-empty">Yeni bildirim yok.</p><?php endif;?></div></div></details>
...
<div class="command-palette" data-command-palette hidden>
    ...
    <section role="dialog" aria-modal="true" aria-label="Hızlı menü araması">
        ...
        <div class="command-results" data-command-results>
            <div class="command-section-label">SAYFALAR VE İŞLEMLER</div>
            ...
            <div class="command-section-label command-live-label" hidden>CANLI SONUÇLAR</div>
            <div data-command-live></div>
        </div>
