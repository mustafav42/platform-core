...
<link rel="stylesheet" href="assets/admin-v2.css?v=27.2.0">
...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-list" aria-label="Yönetim menüsü">
            <a class="nav-item active" href="./"><span>⌂</span><b>Dashboard</b></a>
            <a class="nav-item" href="../cashier/"><span>▣</span><b>POS / Kasa</b></a>
            <a class="nav-item" href="../admin/?page=products"><span>◇</span><b>Ürünler</b></a>
            <a class="nav-item" href="../admin/?page=tables"><span>▦</span><b>Masalar ve Salonlar</b></a>
            <a class="nav-item" href="../admin/?page=staff"><span>♙</span><b>Personel</b></a>
            <a class="nav-item" href="../admin/?page=reports"><span>↗</span><b>Raporlar</b></a>
            <a class="nav-item" href="../admin/qr-menu.php"><span>⌁</span><b>QR Menü</b></a>
            <a class="nav-item" href="../admin/print-settings.php"><span>▤</span><b>Yazıcılar</b></a>
            <a class="nav-item" href="../admin/brand-center.php"><span>✦</span><b>Marka Merkezi</b></a>
            <a class="nav-item" href="../admin/system-center.php"><span>⚙</span><b>Sistem</b></a>
        </nav>
        <div class="sidebar-bottom">
            <div class="health-pill"><i class="<?= $systemHealthy ? 'ok' : 'warn' ?>"></i><?= $systemHealthy ? 'Sistem hazır' : 'Kontrol gerekli' ?></div>
            <a class="legacy-link" href="../admin/">Eski panele dön</a>
        </div>
    </aside>
    ...
    <main class="main-content">
        <header class="topbar">
            ...
            <div class="top-actions"><a class="icon-button" href="../admin/brand-center.php" title="Marka Merkezi">✦</a><a class="avatar" href="../admin/?logout=1" title="Çıkış"><?=e(mb_strtoupper(mb_substr($adminName,0,1)))?></a></div>
        </header>
        ...
        <section class="hero-row">
            ...
            <div class="hero-actions"><a class="button secondary" href="../admin/?page=reports">Raporları aç</a><a class="button primary" href="../cashier/">Kasaya git</a></div>
        </section>
        ...
        <section class="quick-actions card">
            ...
            <div class="action-grid">
                <a href="../admin/?page=products" class="action-tile"><i>＋</i><div><b>Yeni ürün</b><span>Ürün kataloğunu yönet</span></div></a>
                <a href="../admin/?page=tables" class="action-tile"><i>▦</i><div><b>Masa düzeni</b><span>Salon ve masaları aç</span></div></a>
                <a href="../admin/?page=staff" class="action-tile"><i>♙</i><div><b>Yeni personel</b><span>PIN ve yetki tanımla</span></div></a>
                <a href="../admin/qr-menu.php" class="action-tile"><i>⌁</i><div><b>QR Menü</b><span>Dijital menüyü yönet</span></div></a>
                <a href="../admin/print-settings.php" class="action-tile"><i>▤</i><div><b>Yazıcı ayarı</b><span>Mutfak çıktısını kontrol et</span></div></a>
                <a href="../admin/brand-center.php" class="action-tile"><i>✦</i><div><b>Marka Merkezi</b><span>Logo ve renkleri değiştir</span></div></a>
            </div>
        </section>
        ...
        <section class="dashboard-grid lower-grid">
            ...
            <article class="card">
                <div class="section-head"><div><span class="eyebrow">SON TAHSİLATLAR</span><h3>Ödeme hareketleri</h3></div><a href="../admin/?page=reports">Rapor →</a></div>
        ...
        <section class="card top-products">
            <div class="section-head"><div><span class="eyebrow">BUGÜN</span><h3>En çok satan ürünler</h3></div><a href="../admin/?page=reports">Detaylı rapor →</a></div>
...
<script src="assets/admin-v2.js?v=27.2.0"></script>
</body>
</html>
