...
$staffId=(int)$_SESSION['cashier_id'];$tableLifecycle=table_lifecycle_service($pdo);$selected=(int)($_GET['session']??0);$categoryId=(int)($_GET['category']??0);
