...
$healthItems = [
    ...(module_enabled('qr-menu',true) ? [['label' => 'QR Menü', 'ok' => ent_setting('qr_menu_enabled', '1') === '1', 'text' => ent_setting('qr_menu_enabled', '1') === '1' ? 'Yayında' : 'Kapalı']] : []),
...
<section class="welcome-card aurora-welcome">
    ...
    <div class="welcome-actions"><button type="button" class="primary-action" data-command-open>Hızlı İşlem</button><?php if(module_enabled('cashier',true)):?><a href="../../cashier/" class="secondary-action">POS’u Aç</a><?php endif;?></div>
</section>
...
<section class="panel-card">
    ...
    <div class="quick-grid aurora-actions">
        ...
        <?php if(module_enabled('qr-menu',true)):?><a href="../qr-experience/"><b>◈</b><span>QR Studio</span></a><?php endif;?>
...
<div class="dashboard-grid aurora-grid">
<section class="panel-card">
<header><div><span>SON İŞLEMLER</span><h3>Control Center aktivitesi</h3></div><a href="audit.php">Tümünü gör →</a></header>
